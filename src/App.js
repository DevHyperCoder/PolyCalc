...
<h2 className="heading">First Polynomial</h2>
      <div className="poly-container">
        <div className="poly">
          <input type="number" name="p1-a" className="mathInput" id="p1-a" onChange={() => set_p1_a(document.getElementById('p1-a').value)} />
          <p>x²</p>
          <p>+</p>
          <input type="number" name="p1-b" className="mathInput" id="p1-b" onChange={() => set_p1_b(document.getElementById('p1-b').value)} />
          <p>x</p>
          <p>+</p>
          <input type="number" name="p1-c" className="mathInput" id="p1-c" onChange={() => set_p1_c(document.getElementById('p1-c').value)} />
          <p>=</p>
          <p>0</p>
        </div>
      </div>
      ...
      <div className="poly-container">
        <div className="poly">
          <input type="number" name="p2-a" className="mathInput" id="p2-a" onChange={() => set_p2_a(document.getElementById('p2-a').value)} />
          <p>x²</p>
          <p>+</p>
          <input type="number" name="p2-b" className="mathInput" id="p2-b" onChange={() => set_p2_b(document.getElementById('p2-b').value)} />
          <p>x</p>
          <p>+</p>
          <input type="number" name="p2-c" className="mathInput" id="p2-c" onChange={() => set_p2_c(document.getElementById('p2-c').value)} />
          <p>=</p>
          <p>0</p>
        </div>
      </div>
